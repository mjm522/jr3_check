...
#define RAW_C			0x0000 //0
#define COPYRIGHT 		0x0040 //64
#define SHUNTS			0x0060 //96
#define DEFAULT_F 		0x0068 //104
#define LOAD_E_N  		0x006f //111
#define MIN_F_S			0x0070 //112
#define TRANSFORM_N		0x0077 //119
#define MAX_F_S 		0x0078 //120
#define PEAK_A			0x007f //127
#define FULL_S			0x0080 //128
#define OFFSETS			0x0088 //136
#define OFFSET_N		0x008e //142
#define VECT_A			0x008f //143
#define FILTER0			0x0090 //144
#define FILTER1			0x0098 //152
#define FILTER2			0x00a0 //160
#define FILTER3			0x00a8 //168
#define FILTER4			0x00b0 //176
#define FILTER5			0x00b8 //184
#define FILTER6			0x00c0 //192
#define RATE_DA			0x00c8 //200
#define MINIMUM_D		0x00d0 //208
#define MAXIMUM_D		0x00d8 //216
#define NEAR_S_V		0x00e0 //224
#define SAT_V			0x00e1 //225
#define RATE_A			0x00e2 //226
#define RATE_DI			0x00e3 //227
#define RATE_C			0x00e4 //228
#define COMMAND_W2		0x00e5 //229
#define COMMAND_W1		0x00e6 //230
#define COMMAND_W0		0x00e7 //231
#define COUNT1			0x00e8 //232
#define COUNT2			0x00e9 //233
#define COUNT3			0x00ea //234
#define COUNT4			0x00eb //235
#define COUNT5			0x00ec //236
#define COUNT6			0x00ed //237
#define ERROR_C			0x00ee //238
#define COUNT_X			0x00ef //239
#define WARNINGS		0x00f0 //240
#define ERRORS			0x00f1 //241
#define THRESHOLD_B		0x00f2 //242
#define LAST_C			0x00f3 //243
#define EEPROM_V_N		0x00f4 //244
#define SOFTWARE_V_N	0x00f5 //245
#define SOFTWARE_D		0x00f6 //246
#define SOFTWARE_Y		0x00f7 //247
#define SERIAL_N		0x00f8 //248
#define MODEL_N			0x00f9 //249
#define CAL_D			0x00fa //250
#define CAL_Y			0x00fb //251
#define UNITS			0x00fc //252
#define BITS			0x00fd //253
#define CHANNELS		0x00fe //254
#define THICKNESS		0x00ff //255
#define LOAD_E			0x0100 //256
#define TRANSFORMS		0x0200 //512
...
{
	unsigned tx_near_sat : 1;
	unsigned ty_near_sat : 1;
	unsigned tz_near_sat : 1;
	unsigned rx_near_sat : 1;
	unsigned ry_near_sat : 1;
	unsigned rz_near_sat : 1;
